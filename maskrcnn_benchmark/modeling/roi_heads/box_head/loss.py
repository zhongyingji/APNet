...
class FastRCNNLossComputation(object):
    ...
    def __call__(self, class_logits, box_regression, embed_norm):
        """
        Computes the loss for Faster R-CNN.
        ...
        embed_norm = cat(embed_norm, dim=0)
        ...
        ids = cat([proposal.get_field("ids") for proposal in proposals], dim=0)
        ...
        id_cls_loss, _ = self.oim(embed_norm[sampled_pos_inds_subset], ids[sampled_pos_inds_subset])
        
        return classification_loss, box_loss, id_cls_loss
